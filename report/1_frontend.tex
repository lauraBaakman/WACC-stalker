...
\section{Design}
\label{sec:1:design}
	In this section we will discuss the control flow in the front end upon certain actions of the user. 
	...
	\subsection{Log In}
		...
		\begin{figure}
			\missingfigure{Control flow of logging in}
		...
		\begin{figure}
			\begin{subfigure}{\textwidth}
				\missingfigure{Screenshot of the application when a user is not logged into LinkedIn.}
				\caption{The view when the user is not logged into LinkedIn.}
				\label{fig:1:viewLogIn:linkedin}
			\end{subfigure}
			\begin{subfigure}{\textwidth}
				\missingfigure{Screenshots of the application when a user is logged into facebook.}	
