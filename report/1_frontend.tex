...
\label{sec:1:design}
	...
	\subsection{Start Stalking}
		\Cref{fig:1:controlflowStartStalk} shows what happens in the front end when the button `start stalking', see \autoref{fig:1:viewLogIn}, is pressed.

			\begin{figure}
				\missingfigure{Control flow of start stalking}
