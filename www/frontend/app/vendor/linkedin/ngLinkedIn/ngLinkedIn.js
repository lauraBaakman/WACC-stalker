...
angular.module('ngLinkedIn', [])
    .provider('$linkedIn', function() {
        ...
        this.$get = ['$rootScope', '$q', '$window',
            function($rootScope, $q, $window) {
                ...
                // people search:  403 forbidden? Need to request 'Vetted API Access'
                $linkedIn.peopleSearch = function(params) {
                    var defer = $q.defer();
                    return $linkedIn.promise.then(function(IN) {
                        IN.API.PeopleSearch()
    ...
    .run(['$rootScope', '$linkedIn',
        function($rootScope, $linkedIn) {
            if (!window.IN) {
